...
require_once CF7D_PLUGIN_DIR . '/fpdf_download.php';
require_once CF7D_PLUGIN_DIR . '/pdf/PdfConfig.php';
require_once CF7D_PLUGIN_DIR . '/pdf/PdfHeader.php';
require_once CF7D_PLUGIN_DIR . '/pdf/PdfTransformData.php';
require_once CF7D_PLUGIN_DIR . '/pdf/PDF_MC_Table.php';
